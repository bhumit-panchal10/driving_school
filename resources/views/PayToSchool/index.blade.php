...
@section('title', 'Pay To School List')
@section('content')
...
<div
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-16">Pay To School List</h5>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                            ...
                            <form onsubmit="return validateFile()" class="tablelist-form"
                                action="{{ route('PaySchool.PaySchoollist') }}" method="POST"
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                    ...
                                    <div class="">
                                        ...
                                        <select name="SchoolId" id="SchoolId"
                                            ...
                                            <option value="{{ $School->SchoolId }}"
                                                @if (isset($schoolid) && $schoolid==$School->SchoolId) {{ 'selected' }} @endif>
                                                {{ $School->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="ltr:md:text-end mt-5">
                                        ...
                                        <a href="{{ route('PaySchool.PaySchoollist') }}">
                                            <button type="button"
                        ...
                        <div class="overflow-x-auto">
                                ...
                                <table class="w-full whitespace-nowrap" id="customerTable">
                                    <thead class="bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            ...
                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                data-sort="are_name">Total Orders</th>

                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                data-sort="state_name">Pay To School</th>

                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                data-sort="state_name">AdminShare </th>

                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                                data-sort="state_name">Action</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                {{ $PaySchool->SchoolName }}
                                            </td>
                                            <td
                                                class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                {{ $PaySchool->TotalOrders }}
                                            </td>

                                            <td
                                                class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                {{ $PaySchool->TotalAmount }}
                                            </td>
                                            <td
                                                class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                {{ $PaySchool->TotalAdminShare }}
                                            </td>
                                            <td
                                                class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-toggle="modal" data-modal-target="PaymentModal"
                                                    onclick="openPaymentModal('{{ $PaySchool->TotalAmount }}', '{{ $PaySchool->SchoolName }}','{{ $PaySchool->SchoolId }}','{{ $PaySchool->OrderDate }}')">
                                                    Pay Now
                                                </button>
                            ...
                            <div class="flex items-center justify-between mt-5">
                                {{ $PaySchoollist->appends(request()->except('page'))->links() }}
                            </div>
                            @else
                            <div class="noresult">
            ...
            <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="school_name" id="modalSchoolName" maxlength="50"
                        ...
                        placeholder="Enter School Name" value="" required autocomplete="off" autofocus
                        readonly>
                </div>
                <div class="mb-3">
                    <label for="Countryname-field" class="inline-block mb-2 text-base font-medium">
