...
@section('title', 'Gujarati Question List')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Gujarati Question List</h5>
                </div>
                                    ...
                                    <form id="bulkDeleteForm" method="POST" action="">
                                        ...
                                        <table class="w-full whitespace-nowrap" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                <?php $i = 1; ?>
                                                @foreach ($gujaratiques as $gujaratique)
                                                    <tr class="text-center">
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $gujaratique->question }}
                                                        </td>
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 job_title">
                                                            {{ $gujaratique->option_1 }}
                                                        </td>
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">

                                                            {{ $gujaratique->option_2 }}
                                                        </td>
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">

                                                            {{ $gujaratique->option_3 }}
                                                        </td>
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($gujaratique->image)
                                                                <img class="img-fluid"
                                                                    src="{{ asset('upload/questionImage') . '/' . $gujaratique->image }}"
