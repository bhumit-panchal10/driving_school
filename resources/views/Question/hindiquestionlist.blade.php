...
@section('title', 'Hindi Question List')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Hindi Question List</h5>
                </div>
                                                ...
                                                @foreach ($hindiques as $hindique)
                                                    <tr class="text-center">
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($hindique->image)
                                                                <img class="img-fluid"
                                                                    src="{{ asset('upload/questionImage') . '/' . $hindique->image }}"
