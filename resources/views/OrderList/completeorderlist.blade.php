...
@section('title', 'Complete Order List')
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <div class="grow">
                    ...
                    <h5 class="text-16">Complete Order List</h5>
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li
                        ...
                        <a href="#!" class="text-slate-400 dark:text-zink-200">Complete Order</a>
                    </li>
                                        ...
                                        <table class="w-full whitespace-nowrap" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                @foreach ($completeorderlist as $completeorder)
                                                    <?php
                                                    $totalamt = $completeorder->iNetAmount;
                                                    $advanceamt = $completeorder->advance_payment;
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $completeorder->school->name }}

                                                        </td>
                                                        <td
                                                            class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 job_title">

                                                            {{ $completeorder->packagename->name }}
